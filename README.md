...
| `POST` | `/api/courses/courses/<id>/enroll`            | Student             | Enroll in a course.                                                      |
| `GET` | `/api/courses/courses/<id>/enrollments`       | Admin, Teacher      | View all students enrolled in a course.                                  |
| **Assignments (AI & RAG)** |
| `POST` | `/api/assignments/assignments/upload-notes`   | Teacher             | Upload a `.txt` file to the RAG knowledge base.                          |
| `POST` | `/api/assignments/assignments/generate`       | Teacher             | Generate assignment questions from the knowledge base.                   |
